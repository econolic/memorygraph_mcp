...
def test_router_keeps_requested_mode() -> None:
    ...
    assert routed.recommended_tools == ("kb.search",)
...
def test_router_detects_structural_query() -> None:
    ...
    assert routed.recommended_tools == ("kb.search", "kb.graph_expand")
...
def test_router_detects_memory_intent_with_include_memory() -> None:
    ...
    assert routed.recommended_tools == ("kb.memory.search", "kb.search")
...
def test_router_detects_memory_delete_intent() -> None:
    ...
    assert routed.recommended_tools == ("kb.memory.delete",)
